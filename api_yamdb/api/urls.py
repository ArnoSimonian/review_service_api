...
from api.views import CommentViewSet, CategoryViewSet, GenreViewSet, ReviewViewSet, TitleViewSet, UserRegistrationViewSet
...
router.register(r'v1/auth/signup', UserRegistrationViewSet, basename='signup')
